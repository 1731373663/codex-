...
pub struct BackendSettings {
    ...
    /// Claude Code provider profiles (stored in Codex++ settings, not in ~/.claude/settings.json)
    #[serde(rename = "claudeProfiles", default)]
    pub claude_profiles: Vec<crate::claude_config::ClaudeProfile>,
    /// ID of the currently active Claude Code profile (empty = none selected)
    #[serde(rename = "activeClaudeProfileId", default)]
    pub active_claude_profile_id: String,
}
...
impl Default for BackendSettings {
    fn default() -> Self {
        Self {
            ...
            active_claude_profile_id: String::new(),
        }
    }
}
